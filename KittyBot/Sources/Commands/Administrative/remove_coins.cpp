...
std::vector<dpp::command_option> Kitty::Commands::Administrative::RemoveCoins::options() const
{
  return {
...
void Kitty::Commands::Administrative::RemoveCoins::execute(const dpp::slashcommand_t& event)
{
  // Check guild
